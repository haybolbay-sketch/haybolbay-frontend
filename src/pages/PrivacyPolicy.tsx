            ...
            <section className="space-y-4">
              ...
              <div className="space-y-6 ml-4">
                <div>
                  ...
                  <p className="text-sm">When creating an account, users may provide: Full name, Mobile number, Email address,  Password (encrypted/authenticated through secure providers), Profile photo, Date of birth (if required), Government-issued identification (where applicable) and payment-related contact details, including the mobile number or email address associated with your GCash, Maya, or other supported payment account, where needed for booking confirmation, payment verification, refunds, account security, and service communication. Role types include: Host / Landlord, Cleaner / Service Provider, Guest / Client.</p>
                </div>
